...
class CX2TwinStrategyTest {

    @Test
    void createOffspring1() {
        ...
        CX2TwinStrategy CX2TwinStrategy = new CX2TwinStrategy();

        //when
        List<Mutable> list = CX2TwinStrategy.createOffspring(parent1, parent2);
...
//given
        ...
        //then
        System.out.println(child1Actual);
        System.out.println(child2Actual);
        assertEquals(child2, child2Actual);
        assertEquals(child1, child1Actual);
    }
}